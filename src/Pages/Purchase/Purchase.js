            ...
            <div class="hero">
                <div class="hero-content flex-col lg:flex-row">
                    <div class="text-center lg:text-left ">
                        <div className="card lg:max-w-lg w-96 shadow-2xl mx-2">
                            ...
                            <div className="card-body text-center">
                                ...
                                <p className='text-lg text-neutral '>Minimum Purchase Quantity: <input className='input input-bordered w-32 text-xl font-medium' type="number" value={eachParts.minQuantity} /></p>
                            </div>
                        </div>
                    </div>
                    <div class="card flex-shrink-0 max-w-sm shadow-2xl bg-base-100 text-center">
                        <div class="card-body">
                            <form className='my-3 w-full lg:mx-0 mx-auto' onSubmit={handleSubmit(onSubmit)}>
